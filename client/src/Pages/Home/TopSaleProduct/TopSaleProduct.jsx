...
const TopSaleProduct = () => {
  ...
  const sliderRef2 = useRef(null); // Ref to store the Keen Slider instance
...
useEffect(() => {
  ...
  sliderRef2.current = new KeenSlider(sliderElement, {
    ...
    breakpoints: {
      "(min-width: 1024px)": { slides: { origin: "auto", perView: 4, spacing: 20 } },
      "(max-width: 600px)": { slides: { origin: "center", perView: 1, spacing: 0 } },
    },
  });

  document.getElementById("keen-slider-previous-topsale")?.addEventListener("click", () => sliderRef2.current.prev());
  document.getElementById("keen-slider-next-topsale")?.addEventListener("click", () => sliderRef2.current.next());
    ...
    <div className="mt-16 mb-16">
      ...
      />
          ...
          <p className="text-center font-bold text-2xl text-primary">
             No top sale product arrived yet. <br/>Stay tuned with us
          </p>
        ) :
        ( <>
      ...
      <div id="keen-slider-topsale" className="mt-16 keen-slider cursor-grabbing">
